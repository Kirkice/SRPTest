...
public class GIRenderer : System.IDisposable {
    ...
    public KirkRenderPipeline RenderPipeline { get; }
    #endregion
    ...
    #region KirkRenderPipelineGI
    public GIRenderer(KirkRenderPipeline renderPipeline) {
    RenderPipeline = renderPipeline;

    _command = new CommandBuffer { name = "KirkGI.Renderer" };
    ...
    public void RenderDeferred(ScriptableRenderContext renderContext, Camera camera, KirkGI gi) {
    ...
    void RenderLighting(ScriptableRenderContext renderContext, Camera camera, KirkGI gi)
    {
    ...
    void TriggerCameraEvent(ScriptableRenderContext renderContext, Camera camera, CameraEvent cameraEvent, KirkGI gi)
    {
#if UNITY_EDITOR
    ...
    void UpdatePostProcessingLayer(ScriptableRenderContext renderContext, Camera camera, KirkGI gi)
    {
