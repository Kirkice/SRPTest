...
[AddComponentMenu("Rendering/KirkGI")]
public class KirkGI : MonoBehaviour {
    /// <summary>
    /// 公共变量
    /// </summary>
    ...
    #region Rendering
    public void Render(ScriptableRenderContext renderContext, GIRenderer renderer)
    {
        Render(renderContext, Camera, renderer);
    }

    public void Render(ScriptableRenderContext renderContext, Camera camera, GIRenderer renderer)
    {
        KirkRenderPipeline.TriggerCameraCallback(Camera, "OnPreRender", Camera.onPreRender);
        ...
        KirkRenderPipeline.TriggerCameraCallback(Camera, "OnPreCull", Camera.onPreCull);
        ...
        KirkRenderPipeline.TriggerCameraCallback(Camera, "OnPostRender", Camera.onPostRender);
    }

    void PrePass(ScriptableRenderContext renderContext, GIRenderer renderer)
    {
    ...
    void OnEnable()
    {
        ...
        _command = new CommandBuffer { name = "KirkGI.MonoBehaviour" };
