Shader "Hidden/KirkGI/Lighting"
{
  ...
  HLSLINCLUDE
    ...
    #include "Assets/KirkRenderPipeline/ShaderLibrary/BlitSupport.hlsl"
    #include "Assets/KirkRenderPipeline/ShaderLibrary/Radiances/Pixel.cginc"
