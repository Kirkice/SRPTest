...
{
    public class KPostProcessingUtility
    {
        #region Instance

        private static KPostProcessingUtility _instance;
        public static KPostProcessingUtility Instance
        {
            get
            {
                if (_instance == null)
                {
                    _instance = new KPostProcessingUtility();
                }
                return _instance;
            }
        }
        ...
        static string TypePreFix = "KPostProcessing.";
